...
//        Button check_permission = (Button) findViewById(R.id.check_permission);
        Button request_permission = (Button) findViewById(R.id.save_location);
...
//                    newLocation.child("Longitude").setValue(location.getLongitude());
                    ...
                    Toast.makeText(getApplicationContext(), "Location saved in database", Toast.LENGTH_LONG).show();
